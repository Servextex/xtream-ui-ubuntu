...
wget -q -O /tmp/xtreamcodes.tar.gz https://github.com/Servextex/xtream-ui-ubuntu/releases/download/start/main_xui_"$OSNAME"_"$VER".tar.gz
...
#### update xtream cr 41
# backup R41
#wget -q -O /tmp/update.zip https://github.com/Servextex/xtream-ui-ubuntu/releases/download/start/update.zip
#xcversion=41
#install latest
