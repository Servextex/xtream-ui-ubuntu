...
rDownloadURL = {"main": "https://github.com/Servextex/xtream-ui-ubuntu/releases/download/start/iptv_xtream_codes.zip", "sub": "https://github.com/Servextex/xtream-ui-ubuntu/releases/download/start/sub_xtreamcodes_reborn.tar.gz"}
