#!/bin/bash
wget -qO- https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/depbuild.sh | bash -s
apt-get update
...
rm -f install.py
curl -L -o install.py https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/install.py
python install.py
rm -f install.py
apt-get -y install libcurl4 curl
wget https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/xcphp_7.3.33-1_amd64.deb -O xcphp_7.3.33-1_amd64.deb
dpkg -i xcphp_7.3.33-1_amd64.deb
rm -f xcphp_7.3.33-1_amd64.deb
wget https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/xcphp-mcrypt_1.0.5-1_amd64.deb -O xcphp-mcrypt_1.0.5-1_amd64.deb
dpkg -i xcphp-mcrypt_1.0.5-1_amd64.deb
rm -f xcphp-mcrypt_1.0.5-1_amd64.deb
wget https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/xcphpgeoip_1.1.1-1_amd64.deb -O xcphpgeoip_1.1.1-1_amd64.deb
...
rm -f ioncube*
wget https://raw.githubusercontent.com/Servextex/xtream-ui-ubuntu/main/ubuntu/php.ini -O /home/xtreamcodes/iptv_xtream_codes/php/lib/php.ini
